...
let streaming = [`p$help`, `10 invites fulldata`, `System⚙️`];
...
client.on("message", message => {
    var prefix = "p$"; // غير هنا حط البرفكس
...
**═════════════════════**
                        **اوامر عادية**
p$linkdm  || ارسال رابط السيرفر بالخاص
p$link || لينك اي بوت يجب عليك ان تمنشن البوت
p$cat || صور قطط كيوت
p$sug || للأقتراح
p$invites || لمعرفة عدد دعواتك
p$invite || لمعرفة عدد دعواتك
p$members || معرفة معلومات الاعبين
p$rps || حجرة ورقة مقص __قد تكون معطله__
p$mar ||  لعبة الزواج
p$new || لفتح تذكرة
p$counting || للعد
**═════════════════════**
                        **اوامر ادارية**
p$giveaway || قيف اواي
p$clean || لمسح 12 رسالة فقط
p$server || لمعرفة معلومات السيرفر
p$gRole || لمعرفة معلومات الرتبة
p$id || ملفك
p$cc || انشاء الوان 
p$closec || قفل الشات
p$openc || فتح الشات
p$clear 50 || لمسح 50 رسالة
p$bc || برودكاست
p$ban  || بان
